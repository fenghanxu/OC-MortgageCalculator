...
+(ImageColorModel *)mostColor:(UIImage *)image{
    ...
    ImageColorModel * model = [[ImageColorModel alloc] init];
    ...
    NSInteger count = [MaxColor[0] intValue] + [MaxColor[1] intValue] + [MaxColor[2] intValue];
    model.colorCount = count;
    
    model.alpha = [MaxColor[3] intValue]/255.0f;
